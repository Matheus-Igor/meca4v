...
float resultadoDaCinematicaDoServo1 = 0; // resultado da cinematica do servo 1 que varia de 0 a 180
...
float resultadoDaCinematicaDoServo2 = 0; // resultado da cinematica do servo 2 que varia de 0 a 180
...
};// coordenadas x e y que a caneta deve alcançar
...
void atualizeServos(){
    float anguloDoServo1 = resultadoDaCinematicaDoServo1;
    float anguloDoServo2 = resultadoDaCinematicaDoServo2;
